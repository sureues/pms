...
Webfm.js_msg = [];
Webfm.js_msg["mkdir"] = Drupal.t("Créer un nouveau répertoire");
Webfm.js_msg["file"] = Drupal.t("fichier");
Webfm.js_msg["dir"] = Drupal.t("répertoire");
Webfm.js_msg["u_file"] = Drupal.t("Fichier");
Webfm.js_msg["u_dir"] = Drupal.t("Répertoire");
Webfm.js_msg["tree"] = Drupal.t("");
Webfm.js_msg["work"] = Drupal.t("En cours... patientez s'il vous plaît");
Webfm.js_msg["refresh"] = Drupal.t("rafraîchir");
Webfm.js_msg["sort"] = Drupal.t("trier par cette colone");
Webfm.js_msg["new-dir"] = Drupal.t("Créer un nouveau dossier");
Webfm.js_msg["add-2-db"] = Drupal.t("Ajouter les fichiers de ce répertoire à la base de donnée");
Webfm.js_msg["r-add-2-db"] = Drupal.t("Recursive add files to database");
Webfm.js_msg["column1"] = Drupal.t("Nom");
Webfm.js_msg["column2"] = Drupal.t("Modifié");
Webfm.js_msg["column3"] = Drupal.t("Taille");
Webfm.js_msg["column4"] = Drupal.t("Propriétaire");
Webfm.js_msg["attach-title"] = Drupal.t("Fichiers attachés");
Webfm.js_msg["meta-title"] = Drupal.t("File Meta Data");
Webfm.js_msg["search-title"] = Drupal.t("Recherche de fichier");
Webfm.js_msg["debug-title"] = Drupal.t("WebFM Debug");
Webfm.js_msg["cache-title"] = Drupal.t("Répertoire cache");
Webfm.js_msg["search-cur"] = Drupal.t("Recherche du dossier courant (see listing breadcrumb trail)");
Webfm.js_msg["no-match"] = Drupal.t("Aucune correspondance trouvé");
Webfm.js_msg["search"] = Drupal.t("Rechercher");
Webfm.js_msg["submit"] = Drupal.t("Envoyer");
Webfm.js_msg["reset"] = Drupal.t("Remetre à zéro");
Webfm.js_msg["clear"] = Drupal.t("Effacer");
Webfm.js_msg["cancel"] = Drupal.t("Annuler");
Webfm.js_msg["close"] = Drupal.t("Fermer");
Webfm.js_msg["resize"] = Drupal.t("Resize");
Webfm.js_msg["replace"] = Drupal.t("Remplacer et copie de la version original de ");
Webfm.js_msg["replace-del"] = Drupal.t("Remplacer et supprimer la version originale de ");
Webfm.js_msg["no-replace"] = Drupal.t("Nouvelle copie de ");
Webfm.js_msg["cache"] = Drupal.t("Contenu du cache");
Webfm.js_msg["curdir-undef"] = Drupal.t("Dossier courant indéfini");
Webfm.js_msg["ajax-err"] = Drupal.t("Le server n'est pas joignable");
Webfm.js_msg["move-err"] = Drupal.t("Le déplacement du fichier à échoué");
Webfm.js_msg["len-err"] = Drupal.t("Trop long");
Webfm.js_msg["confirm-del0"] = Drupal.t("Voulez vous supprimer le ");
Webfm.js_msg["confirm-del1"] = Drupal.t(" et tout ses contenants ?");
Webfm.js_msg["confirm-det"] = Drupal.t("Voulez vous détacher ");
Webfm.js_msg["confirm-dbrem0"] = Drupal.t("Voulez vous enlever ");
Webfm.js_msg["confirm-dbrem1"] = Drupal.t(" de la base de donnée?\n     Toutes les métadonnées et pièces jointes à ce fichier seront perdu");
Webfm.js_msg["enum_local"] = Drupal.t("Voulez vous ajouter tout les fichiers de ce dossier dans la base de donnée?");
Webfm.js_msg["enum_recur"] = Drupal.t("Voulez vous ajouter tout les fichiers de ce dossier et de ses sous-dossiers dans la base de donnée?");
Webfm.js_msg["file-dwld"] = Drupal.t("Télécharger le fichier");
Webfm.js_msg["no-file-dwld"] = Drupal.t("Le fichier n'est pas dans la base de donnée");
Webfm.js_msg["inserted"] = Drupal.t(" fichiers insérés dans la base de donnée");
Webfm.js_msg["not-inserted"] = Drupal.t(" fichiers non insérés dans la base de donnée");
Webfm.js_msg["metadata"] = Drupal.t("Metadonnée");
Webfm.js_msg["fix_input"] = Drupal.t("insertion correcte");
Webfm.js_msg["perm"] = Drupal.t("Droits du fichier");

Webfm.meta_msg = [];
Webfm.meta_msg["fid"] = Drupal.t("fid");
Webfm.meta_msg["uid"] = Drupal.t("uid");
Webfm.meta_msg["uname"] = Drupal.t("Propriétaire du fichier");
Webfm.meta_msg["name"] = Drupal.t("nom");
Webfm.meta_msg["title"] = Drupal.t("titre");
Webfm.meta_msg["desc"] = Drupal.t("description");
Webfm.meta_msg["lang"] = Drupal.t("language");
Webfm.meta_msg["pub"] = Drupal.t("publié par");
Webfm.meta_msg["format"] = Drupal.t("format");
Webfm.meta_msg["ver"] = Drupal.t("version");
Webfm.meta_msg["type"] = Drupal.t("type de l'image");
Webfm.meta_msg["width"] = Drupal.t("largeur");
Webfm.meta_msg["height"] = Drupal.t("hauteur");
Webfm.meta_msg["dl_cnt"] = Drupal.t("téléchargements");
Webfm.meta_msg["link"] = Drupal.t("lien");

Webfm.perm_msg = [];
Webfm.perm_msg["pub_view"] = Drupal.t("Téléchargement public");
Webfm.perm_msg["rol_view"] = Drupal.t("Vue/Télécharment du rôle");
Webfm.perm_msg["rol_att"] = Drupal.t("Attachement du rôle");
Webfm.perm_msg["rol_full"] = Drupal.t("Accès complet au rôle");

Webfm.menu_msg = [];
Webfm.menu_msg["mkdir"] = Drupal.t("Créer un sous-dossier");
Webfm.menu_msg["rmdir"] = Drupal.t("Supprimer le dossier");
Webfm.menu_msg["rm"] = Drupal.t("Supprimer le fihier");
Webfm.menu_msg["rendir"] = Drupal.t("Renommer le dossier");
Webfm.menu_msg["search"] = Drupal.t("Chercher un dossier");
Webfm.menu_msg["ren"] = Drupal.t("Renommer le fichier");
Webfm.menu_msg["meta"] = Drupal.t("Métadonnées du fichier");
Webfm.menu_msg["att"] = Drupal.t("Attacher au noeud");
Webfm.menu_msg["det"] = Drupal.t("Détacher du noeud");
Webfm.menu_msg["dwnld"] = Drupal.t("Télécharger comme un fichier");
Webfm.menu_msg["view"] = Drupal.t("Voir le fichier");
Webfm.menu_msg["enum"] = Drupal.t("Ajouter le fichier à la base de donnée");
Webfm.menu_msg["denum"] = Drupal.t("Enlever le fichier à la base de donnée");
Webfm.menu_msg["perm"] = Drupal.t("Droit du fichier");
Webfm.menu_msg["clip"] = Drupal.t("Copier le lien dans le presse papier");
Webfm.menu_msg["paste"] = Drupal.t("Copier le lien dans la fenêtre de l'éditeur");
