 ...
 *
 * Revision: $Id: jquery.jeditable.js,v 1.1.2.1 2009/03/06 08:32:31 eastcn Exp $
 *
 */
...
(function($) {
    ...
    $.fn.editable = function(target, options) {
        ...
        var settings = {
            ...
            loadtype   : 'GET',
            loadtext   : 'Loading...',
            placeholder: Drupal.t('Click to edit'),
            loaddata   : {},
            submitdata : {}
        };
        ...
        return this.each(function() {
            ...
            var self = this;  
            var ajaxurl = $(this).attr('ajaxedit');
                ...
                form.submit(function(e) {
                    ...
                    if (false !== submit.apply(form, [settings, self])) { 
                      ...
                      if ($.isFunction(settings.target)) {
                          ...
                          $.post(ajaxurl, submitdata, function(str) {
                              $(self).html(str);
                              self.editing = false;
                              callback.apply(self, [self.innerHTML, settings]);
                              /* TODO: this is not dry */                              
